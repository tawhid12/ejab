                      ...
                      <div class="card-body">
                          <form class="form" method="post" action="{{route(currentUser().'.page.store')}}">
                              @csrf
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <label for="published"><b>{{__('Show Section')}}<span class="text-danger">*</span></b></label>
                                    </div>
                                    <div class="col-12">
                                        <select class="form-control form-select" value="{{ old('show_ection')}}" name="show_section">
