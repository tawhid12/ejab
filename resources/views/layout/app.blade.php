...
<head>
    ...
    <title>EJAB Group | @yield('siteTitle', 'Dashboard')</title>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                    ...
                                    <li><a class="dropdown-item" href="{{route(currentUser().'.profile')}}"><i class="icon-mid bi bi-person me-2"></i> My
                                            Profile</a></li>
                                    <li><a class="dropdown-item" href="{{route(currentUser().'.change_password')}}"><i class="icon-mid bi bi-gear me-2"></i>
