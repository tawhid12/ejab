                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="given_name" class="form-control" value="{{ old('given_name')}}" name="given_name">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="linked_in_profile" class="form-control" value="{{ old('linked_in_profile')}}" name="linked_in_profile">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="facebook_profile" class="form-control" value="{{ old('facebook_profile')}}" name="facebook_profile">
