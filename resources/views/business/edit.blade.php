...
@section('pageTitle',trans('Edit Business'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.business.update',encryptor('encrypt',$b->id))}}">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <img width="50px" src="{{asset('uploads/business/thumb/'.$b->image)}}" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <img width="100px" src="{{asset('uploads/page_image/thumb/'.$b->page_image)}}" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_1_headline" class="form-control" value="{{ old('sec_1_headline',$b->sec_1_headline)}}" name="sec_1_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_1_link" class="form-control" value="{{ old('sec_1_link',$b->sec_1_link)}}" name="sec_1_link">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <img width="100px" src="{{asset('uploads/sec_1_image/thumb/'.$b->sec_1_image)}}" alt="">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sec_1_desc" class="form-control" name="sec_1_desc" rows="5">{{ old('sec_1_desc',$b->sec_1_desc)}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_2_headline" class="form-control" value="{{ old('sec_2_headline',$b->sec_2_headline)}}" name="sec_2_headline">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_2_box_text" class="form-control" value="{{ old('sec_2_box_text',$b->sec_2_box_text)}}" name="sec_2_box_text">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="sec_2_link">Section Link</label>
                                            <input type="text" id="sec_2_link" class="form-control" value="{{ old('sec_2_link',$b->sec_2_link)}}" name="sec_2_link">
                                            @if($errors->has('sec_1_link'))
                                            <span class="text-danger"> {{ $errors->first('sec_1_link') }}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="sec_2_image" class="form-control" name="sec_2_image">
                                            <img width="150px" src="{{asset('uploads/sec_2_image/thumb/'.$b->sec_2_image)}}" alt="">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="sec_2_desc">Section Description</label>
                                            <textarea id="sec_2_desc" class="form-control" name="sec_2_desc" rows="5">{{ old('sec_2_desc',$b->sec_2_desc)}}</textarea>
                                            @if($errors->has('sec_1_desc'))
                                            <span class="text-danger"> {{ $errors->first('sec_1_desc') }}</span>
                                            @endif
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_headline" class="form-control" value="{{ old('sec_3_headline',$b->sec_3_headline)}}" name="sec_3_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_box_text" class="form-control" value="{{ old('sec_3_box_text',$b->sec_3_box_text)}}" name="sec_3_box_text">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="sec_3_image" class="form-control" name="sec_3_image">
                                            <img width="100px" src="{{asset('uploads/sec_3_image/thumb/'.$b->sec_3_image)}}" alt="">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_box_1_headline" class="form-control" value="{{ old('sec_3_box_1_headline',$b->sec_3_box_1_headline)}}" name="sec_3_box_1_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sec_3_box_1_detl" class="form-control" name="sec_3_box_1_detl" rows="3">{{ old('sec_3_box_1_detl',$b->sec_3_box_1_detl)}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_box_2_headline" class="form-control" value="{{ old('sec_3_box_2_headline',$b->sec_3_box_2_headline)}}" name="sec_3_box_2_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="sec_3_box_1_detl">Box Description</label>
                                            <textarea id="sec_3_box_2_detl" class="form-control" name="sec_3_box_2_detl" rows="3">{{ old('sec_3_box_2_detl',$b->sec_3_box_2_detl)}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_box_3_headline" class="form-control" value="{{ old('sec_3_box_3_headline',$b->sec_3_box_3_headline)}}" name="sec_3_box_3_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sec_3_box_3_detl" class="form-control" name="sec_3_box_3_detl" rows="3">{{ old('sec_3_box_3_detl',$b->sec_3_box_3_detl)}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_3_box_4_headline" class="form-control" value="{{ old('sec_3_box_4_headline',$b->sec_3_box_4_headline)}}" name="sec_3_box_4_headline">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sec_3_box_4_detl" class="form-control" name="sec_3_box_4_detl" rows="3">{{ old('sec_3_box_4_detl',$b->sec_3_box_4_detl)}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="sec_4_image" class="form-control" name="sec_4_image">
                                            <img width="100px" src="{{asset('uploads/sec_4_image/thumb/'.$b->sec_4_image)}}" alt="">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sec_4_headline" class="form-control" value="{{ old('sec_4_headline',$b->sec_4_headline)}}" name="sec_4_headline">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="sec_4_link1">Social Link (facebook)</label>
                                            <input type="text" id="sec_4_link1" class="form-control" value="{{ old('sec_4_link1',$b->sec_4_link1)}}" name="sec_4_link1">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="sec_4_link2">Social Link (twitter)</label>
                                            <input type="text" id="sec_4_link2" class="form-control" value="{{ old('sec_4_link2',$b->sec_4_link2)}}" name="sec_4_link2">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="sec_4_link3">Social Link (youtube)</label>
                                            <input type="text" id="sec_4_link3" class="form-control" value="{{ old('sec_4_link3',$b->sec_4_link3)}}" name="sec_4_link3">
                                ...
                                <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="gallery_id">Photo Gallery</label>
                                            <select class="form-control" name="gallery_id">
                                            <option value="">Select</option>
                                            @forelse($photo_gal_cat as $p)
                                            <option value="{{$p->id}}" {{ old('gallery_id',$b->gallery_id)==$p->id?"selected":""}}>{{$p->name}}</option>
                                            @empty
                                            @endforelse
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="map" class="form-control" name="map" rows="5">{{ $b->map}}</textarea>
                                        @if($errors->has('map'))
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="footer_email" class="form-control" value="{{ old('footer_email',$b->footer_email)}}" name="footer_email">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="footer_contact" class="form-control" value="{{ old('footer_contact',$b->footer_contact)}}" name="footer_contact">
