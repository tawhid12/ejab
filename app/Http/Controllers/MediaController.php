...
class MediaController extends Controller
{
    ...
    {
        $photoYear=year::all();
        return view('front.media.year',compact('photoYear'));
    }
    /**
     * Show the form for editing the specified resource.
     *
    ...
    {
        $videoYear=year::all();
        return view('front.media.videoYear',compact('videoYear'));
    }
    /**
     * Show the form for editing the specified resource.
     *
    ...
    public function album($slug)
    {
        ...
        return view('front.media.album',compact('pAlbum'));
    }
    /**
     * Show the form for editing the specified resource.
     *
    ...
    public function videoAlbum($slug)
    {
        ...
        return view('front.media.videoAlbum',compact('vAlbum'));
    }
     /**
     * Show the form for editing the specified resource.
     *
    ...
    public function video($slug)
    {
        ...
        return view('front.media.video',compact('video'));
    }
     /**
     * Show the form for editing the specified resource.
     *
    ...
    public function photo($slug)
    {
        ...
        return view('front.media.photo',compact('photo'));
    }
}
